...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/textBox_Username'), 'Admin')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/textBox_Password'), 'hUKwJTbofgPU9eVlw/CnDQ==')
...
WebUI.click(findTestObject('Page_OrangeHRM/i_keyboard_arrow_down'))
